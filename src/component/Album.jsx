...
const Album = () => {
    ...
    return (
        <section className='h-3/4 bg-gradient-to-b from-zinc-900 to-black w-full flex items-center justify-center py-8 md:py-10 lg:py-12 xl:py-16 px-8 md:px-14'>
            <div className='w-full h-full my-4 md:my-8'>
                <div className='container text-center mx-auto text-3xl md:text-5xl lg:text-7xl font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent'>
                    {TITLE.Album}
                </div>
                        ...
                        {IMAGES.map((image, index) => (
                            <div key={index} className='relative group'>
                                <img
                                    ...
                                    className='w-[95%] object-cover h-auto border-2 border-slate-900 rounded-lg mx-auto'
                                />
                ...
                <div className='flex items-center justify-center'>
                    <h3>
                        <Link to={'/album'} className='text-white hover:underline'>
                            View all Discographies
                        </Link>
                    </h3>
                </div>
            </div>
