...
const MainBio = () => {
    ...
    return (
        <section ref={ref} className='relative w-full min-h-screen'>
            ...
            {/* Dark Overlay */}
            <motion.div
                className="absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900 bg-opacity-70"
                initial={{ opacity: 0 }}
                animate={{ opacity: 0.7 }}
                transition={{ duration: 1 }}
            />
            ...
            <div className='relative z-10 w-full py-8 md:py-10 lg:py-12 xl:py-16 px-8 md:px-14'>
                <motion.div
                    className='flex justify-center items-center mx-auto my-6 xl:my-12'
                ...
                >
                    <div className='flex flex-col items-center justify-center pb-1'>
                        ...
                        <Link to={'/'}>
                            <FaArrowLeft
                                size={30}
                                className="text-3xl md:text-5xl text-slate-200 hover:text-violet-400 cursor-pointer transition-all duration-300 mt-4"
                            />
                        </Link>
                    </div>
                </motion.div>
                ...
                <div className='w-full md:w-[95%] lg:w-[95%] xl:w-[95%] container mx-auto p-2 md:p-4 lg:p-8 xl:p-10 my-6 text-slate-200'>
                    ...
                    <motion.div
                        className="relative bg-purple-900 bg-opacity-60 text-white rounded-lg p-6 md:p-10 shadow-lg floating-effect"
                    ...
                    >
                        ...
                        <button
                            onClick={toggleText}
                            className="lg:hidden mt-3 px-4 py-2 bg-violet-700 hover:bg-violet-500 text-sm md:text-lg text-white rounded-lg transition-all duration-300"
                        >
