...
const Gallery = () => {
    return (
        <div
            className='min-h-screen bg-gradient-to-t from-zinc-900 via-zinc-900 to-violet-950 w-full flex items-center justify-center py-8 md:py-10 ld:py-12 xl:py-16 px-8 md:px-14'>
            <div className="w-full my-10">
                <div className='container flex justify-center items-center mx-auto my-2 xl:my-12'>
                    <div className='container mx-auto flex flex-col justify-center items-center pb-2 lg:pb-6'>
                        ...
                        <div className='p-2 text-slate-200 text-sm md:text-md lg:text-lg xl:text-2xl'>Breathtaking
                            Memories
                        </div>
                        <Link to={'/'}><FaArrowLeft size={30}
                                                    className="xl:hidden text-3xl md:text-5xl text-slate-200 hover:text-violet-400 cursor-pointer transition-all duration-300 mt-4 "/></Link>
                    </div>
                </div>
                ...
                <div className="container mx-auto p-4 md:p-8 lg:p-12 xl:p-14 my-8 text-slate-200">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 grid-row-col-dense">
                        ...
                        <div className="col-span-1">
                            ...
                            <img src={DISCOV.Album4} alt="gallery"
                                 className='my-4 cursor-pointer transition-transform duration-300 transform hover:scale-110'/>
                            <img src={NEWS.news3} alt="gallery"
                                 className='cursor-pointer transition-transform duration-300 transform hover:scale-110'/>
                            <img src={NEWS.news2} alt="gallery"
                                 className='mt-4 cursor-pointer transition-transform duration-300 transform hover:scale-110'/>
                        </div>
                        {/* Photo 2 */}
